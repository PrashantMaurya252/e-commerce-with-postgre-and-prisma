...
export default function ProductsGrid({ 
  ...
  products: Product[],
  handleProductAddedToCart:(productId:string)=>void,
  handleProductDecreaseFromCart:(productId:string)=>void,
  handleProductDeleteFromCart:(productId:string)=>void,
  handleProductToggleWishlist?:(productId:string)=>void
}) {
