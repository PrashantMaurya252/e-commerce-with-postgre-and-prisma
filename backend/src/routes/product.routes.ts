...
import { addProduct, cartItems, deleteAllProducts, getAllProducts, productDetails, productSeeder, updateProduct } from '../controllers/product.controller.js'
...
productRouter.get("/cartItems",auth,cartItems)
